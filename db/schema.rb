...
ActiveRecord::Schema[7.2].define(version: 2026_03_01_140958) do
  ...
  create_table "applications", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["feishu_app_id"], name: "index_applications_on_feishu_app_id", unique: true
  ...
  create_table "auth_requests", force: :cascade do |t|
    ...
    t.index ["application_id"], name: "index_auth_requests_on_application_id"
    t.index ["request_id"], name: "index_auth_requests_on_request_id", unique: true
  end
  ...
  create_table "auth_tokens", force: :cascade do |t|
    ...
    t.index ["application_id"], name: "index_auth_tokens_on_application_id", unique: true
  end
  ...
  add_foreign_key "auth_requests", "applications"
  add_foreign_key "auth_tokens", "applications"
