...
Rails.application.routes.draw do
  ...
  resources :applications do
    member do
      get 'SKILL.md', to: 'applications#skill', as: :skill
    end
  end
  ...
  get 'auth/start', to: 'auths#start', as: :auth_start
  post 'auth/authorize', to: 'auths#authorize', as: :auth_authorize
  get 'auth/feishu/callback/:app_id', to: 'auths#feishu_callback', as: :auth_feishu_callback
